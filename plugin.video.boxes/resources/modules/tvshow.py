...
def MERDBTVCATS():
   try:    
          ...
          main.addDir('[COLOR ffe4414f]Search TV Shows[/COLOR]','http://www.merdb.ru/tvshow/?search=','searchtv',artwork + 'search.jpg','','dir')
...
def addMERDBEPDir(name,url,thumb,mode,show,dlfoldername,mainimg,season,episode):
        ...
        if settings.getSetting('metadata') == 'true':
          ...
          fanart = 'http://www.boxes.com.mt/addons/images/fanart/fanart.jpg'
          thumb = 'http://www.boxes.com.mt/addons/icon.png'
