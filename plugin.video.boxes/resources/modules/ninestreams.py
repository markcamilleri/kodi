...
def USERDATABASE():
     #-------------Start Type Fetch------------------------------------
     link=OPEN_URL('http://www.boxes.com.mt/addons/gotham/.xml/all/subtypemenu.xml').replace('\n','').replace('\r','')        
...
def addDBDir(name,url,mode,thumb,desc,key):
        ...
        fanart = 'http://www.boxes.com.mt/addons/images/fanart/fanart.jpg'
        ok=True
...
def NINEMAIN():
     ...
     if customstream =='':
                ...
                if ok:
                        LogNotify('Choose Custom Tab ', 'Add Source & Name', '5000', 'http://www.boxes.com.mt/addons/icon.png')        
...
def NINEMAINLOCAL():
     ...
     if customstream =='':
                ...
                ok = dialog.ok('Source Not Set', '               Please Choose Custom Tab and Add Source')
                if ok:
                        LogNotify('Choose Custom Tab ', 'Add Local Source & Name', '5000', 'http://www.boxes.com.mt/addons/icon.png')        
                        print 'Source Not Set!'
                        addon.show_settings()
     else:     
