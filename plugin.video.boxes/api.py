...
def login(server,username,password):
    plugintools.log("boxes.api login server="+server+", username="+username+", password="+password)
...
def get_recent_movies(token,num_page="",per_page=""):
    plugintools.log("boxes.api.get_recent_movies")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_recent_movies body="+repr(body))
    items = parse_movies(body)
    plugintools.log("boxes.api.get_recent_movies items="+repr(items))

    return items

def get_latest_releases(token,num_page="",per_page=""):
    plugintools.log("boxes.api.get_latest_releases")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_latest_releases body="+repr(body))
    items = parse_movies(body)
    plugintools.log("boxes.api.get_latest_releases items="+repr(items))

    return items

def movie_search(token,terms,num_page="",per_page=""):
    plugintools.log("boxes.api.movie_search")
    ...
    # Response parsing
    plugintools.log("boxes.api.movie_search body="+repr(body))
    items = parse_movies(body)
    plugintools.log("boxes.api.movie_search items="+repr(items))

    return items

def get_hot_movies(token,num_page="",per_page=""):
    plugintools.log("boxes.api.get_hot_movies")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_hot_movies body="+repr(body))
    items = parse_movies(body)
    plugintools.log("boxes.api.get_hot_movies items="+repr(items))

    return items

def get_movies_by_letter(token,letter,num_page="",per_page=""):
    plugintools.log("boxes.api.get_movies_by_letter")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_movies_by_letter body="+repr(body))
    items = parse_movies(body)
    plugintools.log("boxes.api.get_movies_by_letter items="+repr(items))

    return items

def get_movie_genres(token):
    plugintools.log("boxes.api.get_movie_genres")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_movie_genres body="+repr(body))
    items = parse_movie_genres(body)
    plugintools.log("boxes.api.get_movie_genres items="+repr(items))

    return items

def get_movies_by_genre(token,genre,num_page="",per_page=""):
    plugintools.log("boxes.api.get_movies_by_genre")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_movies_by_genre body="+repr(body))
    items = parse_movies(body)
    plugintools.log("boxes.api.get_movies_by_genre items="+repr(items))
...
def get_recent_episodes(token,num_page="",per_page=""):
    plugintools.log("boxes.api.get_recent_episodes")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_recent_episodes body="+repr(body))
    items = parse_tvshow_episodes(body)
    plugintools.log("boxes.api.get_recent_episodes items="+repr(items))

    return items

def get_updated_tvshows(token,num_page="",per_page=""):
    plugintools.log("boxes.api.get_updated_tvshows")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_updated_tvshows body="+repr(body))
    items = parse_tvshows(body)
    plugintools.log("boxes.api.get_updated_tvshows items="+repr(items))

    return items

def tvshow_search(token,terms,num_page="",per_page=""):
    plugintools.log("boxes.api.tvshow_search")
    ...
    # Response parsing
    plugintools.log("boxes.api.tvshow_search body="+repr(body))
    items = parse_tvshows(body)
    plugintools.log("boxes.api.tvshow_search items="+repr(items))

    return items

def get_tvshows_by_letter(token,letter,num_page="",per_page=""):
    plugintools.log("boxes.api.get_tvshows_by_letter")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_tvshows_by_letter body="+repr(body))
    items = parse_tvshows(body)
    plugintools.log("boxes.api.get_tvshows_by_letter items="+repr(items))

    return items

def get_tvshow_seasons(token,tvshow,num_page="",per_page=""):
    plugintools.log("boxes.api.get_tvshow_seasons")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_tvshow_seasons body="+repr(body))
    items = parse_tvshow_seasons(body)
    plugintools.log("boxes.api.get_tvshow_seasons items="+repr(items))

    return items

def get_tvshow_episodes(token,tvshow,season,num_page="",per_page=""):
    plugintools.log("boxes.api.get_tvshow_episodes")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_tvshow_episodes body="+repr(body))
    items = parse_tvshow_episodes(body)
    plugintools.log("boxes.api.get_tvshow_episodes items="+repr(items))

    return items

def get_tvshow_genres(token):
    plugintools.log("boxes.api.get_tvshow_genres")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_tvshow_genres body="+repr(body))
    items = parse_tvshow_genres(body)
    plugintools.log("boxes.api.get_tvshow_genres items="+repr(items))

    return items

def get_tvshows_by_genre(token,genre,num_page="",per_page=""):
    plugintools.log("boxes.api.get_tvshows_by_genre")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_tvshows_by_genre body="+repr(body))
    items = parse_tvshows(body)
    plugintools.log("boxes.api.get_tvshows_by_genre items="+repr(items))
...
def get_livetv_genres(token):
    plugintools.log("boxes.api.get_livetv_genres")
...
def get_livetv_packages(token):
    plugintools.log("boxes.api.get_livetv_packages")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_tvshow_packages body="+repr(body))
    items = parse_livetv_packages(body)
    plugintools.log("boxes.api.get_tvshow_packages items="+repr(items))

    return items

def get_all_livetv_channels(token,num_page="",per_page=""):
    plugintools.log("boxes.api.get_all_livetv_channels")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_all_livetv_channels body="+repr(body))
    items = parse_livetv_channels(body)
    plugintools.log("boxes.api.get_all_livetv_channels items="+repr(items))

    return items

def get_livetv_channels_by_genre(token,genre,num_page="",per_page=""):
    plugintools.log("boxes.api.get_livetv_channels_by_genre")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_livetv_channels_by_genre body="+repr(body))
    items = parse_livetv_channels(body)
    plugintools.log("boxes.api.get_livetv_channels_by_genre items="+repr(items))

    return items

def get_livetv_channels_by_package(token,package,num_page="",per_page=""):
    plugintools.log("boxes.api.get_livetv_channels_by_package")
    ...
    # Response parsing
    plugintools.log("boxes.api.get_livetv_channels_by_package body="+repr(body))
    items = parse_livetv_channels(body)
    plugintools.log("boxes.api.get_livetv_channels_by_package items="+repr(items))

    return items

def get_livetv_url(token,url):
    plugintools.log("boxes.api.get_livetv_url")

    import base64
    plugintools.log("boxes.api.get_livetv_url url="+url)
    url = base64.b64decode(url)
    plugintools.log("boxes.api.get_livetv_url url="+url)

    # Service call
    body , response_headers = plugintools.read_body_and_headers( url )
    plugintools.log("boxes.api.get_livetv_url body="+body)

    mediaurl = base64.b64decode(body)
    plugintools.log("boxes.api.get_livetv_url mediaurl="+mediaurl)
...
def parse_tvshows(body):
    plugintools.log("boxes.api.parse_tvshows")
...
def parse_tvshow_seasons(body):
    plugintools.log("boxes.api.parse_tvshow_episodes")
