...
DATA_PATH = os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.video.boxes'), '')
TMPATH = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.boxes', ''))
